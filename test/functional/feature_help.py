...
"""Verify that starting antomcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start antomcoin with -h for help text")
        ...
        self.log.info("Start antomcoin with -version for version information")
