...
* antomcoin.conf: contains configuration settings for antomcoind or antomcoin-qt
* antomcoind.pid: stores the process id of antomcoind while running
...
* debug.log: contains debug information and general logging generated by antomcoind or antomcoin-qt
