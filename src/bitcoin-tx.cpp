...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s antomcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  antomcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded antomcoin transaction") + "\n" +
              "  antomcoin-tx [options] -create [commands]   " + _("Create hex-encoded antomcoin transaction") + "\n" +
              "\n";
