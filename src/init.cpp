...
void Shutdown()
{
    ...
    RenameThread("antomcoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/antomrivas/antomcoin>";
    const std::string URL_WEBSITE = "<https://www.antomcoin.com>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("antomcoin-loadblk");
...
bool AppInitMain()
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the "
                  "current working directory '%s'. This is fragile, because if antomcoin is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if antomcoin is started while in a temporary directory.\n",
